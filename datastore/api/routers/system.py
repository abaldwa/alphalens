...
Specs: SPEC-DS-002, SPEC-PIPE-001, SPEC-SCHED-005, SPEC-PIPE-005, SPEC-SYS-002
...
date) and drift (pipeline_drift_log, written by daily_inference.py's PSI
check) as the build prompt's parenthetical requires.
"""
...
async def health_check() -> SystemHealthResponse:
    """SPEC-PIPE-001 liveness + SPEC-SCHED-005 pipeline status + stock count + drift status."""
