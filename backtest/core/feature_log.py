...
class FeatureLogWriter:
    ...
    def __init__(
        self, conn: Optional[Any] = None, flush_batch_size: int = DEFAULT_FLUSH_BATCH_SIZE,
    ...
    def _serialize_row(self, r: FeatureLogRow) -> Tuple[str, str, date, str, str, Optional[str], str]:
        return (
