...
CATALOG: list[ExceptionCatalogEntry] = [
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:663",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:1011",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:1051",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:2207",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:2706",
