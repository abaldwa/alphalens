...
CATALOG: list[ExceptionCatalogEntry] = [
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:574",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:922",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:962",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:1875",
    ...
    ExceptionCatalogEntry(
        ...
        location="ingestion/scheduler/daily_pipeline.py:2371",
